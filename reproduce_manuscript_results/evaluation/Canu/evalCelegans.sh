...
cd ../../../
python3 -m elector -threads 16 -uncorrected reproduce_manuscript_results/longReads/simCelegans -corrected reproduce_manuscript_results/correction/Canu/CanuCelegans/CanuCelegans.correctedReads.fasta -reference reproduce_manuscript_results/references/Celegans.fasta -simulator simlord -output CanuCelegans -corrector canu
